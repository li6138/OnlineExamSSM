								...
								<div class="col-md-4">
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>
												<a onclick="document.documentElement.requestFullscreen()" class="btn btn-default btn-lg btn-block beginExam" id="${ep.examPaper.examPaperId }" href="begin?classId=${ep.clazz.classId }&examPaperId=${ep.examPaper.examPaperId }&studentId=${sessionScope.loginStudent.studentId }&examTime=${ep.examPaper.examPaperTime }&gradeId=${gradeId }&beginTime=${ep.beginTime }">进入考试</a>
											</p>
										</div>
									</div>
								</div>
